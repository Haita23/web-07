...
<ul style="list-style:none;" class="m-0 p-0">
    ...
    <li <?php echo (isset($_GET['action']) && $_GET["action"] == 'quanlysp' ? 'class="active"' : '') ?>><a class="d-block my-1 py-3" href="index.php?action=quanlysp&query=them">Quản lý sản phẩm</a></li>
    ...
    <li <?php echo (isset($_GET['action']) && $_GET["action"] == 'quanlybaiviet' ? 'class="active"' : '') ?>><a class="d-block my-1 py-3" href="index.php?action=quanlybaiviet&query=them">Quản lý bài viết</a></li>
